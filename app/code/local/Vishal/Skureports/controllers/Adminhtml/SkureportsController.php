...
{	
     ...
     * @return Vishal_Skureports_Adminhtml_ReportsController
     */
    ...
    {
        $fileName = 'sku_reports.csv';
        $grid = $this->getLayout()->createBlock('skureports/adminhtml_report_grid');
