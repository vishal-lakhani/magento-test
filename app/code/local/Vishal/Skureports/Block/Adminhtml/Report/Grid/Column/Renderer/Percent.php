...
class Vishal_Skureports_Block_Adminhtml_Report_Grid_Column_Renderer_Percent
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    /*
      ...
      and read this way).
      See: Varien_Object (especially ::__call), skureports_Block_Adminhtml_Report_Grid::_prepareColumns().
     */
