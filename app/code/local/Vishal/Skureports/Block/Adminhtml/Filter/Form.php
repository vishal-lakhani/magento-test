...
class Vishal_Skureports_Block_Adminhtml_Filter_Form
    extends Mage_Adminhtml_Block_Widget_Form
{
     ...
     * @return skureports_Block_Adminhtml_Filter_Form
     */
    ...
    protected function _prepareForm()
    {
        ...
        $htmlIdPrefix   = 'skureports_';
        $form->setHtmlIdPrefix($htmlIdPrefix);

        // create a fieldset to add elements to
        $fieldset       = $form->addFieldset('base_fieldset', array('legend' => Mage::helper('skureports')->__('Filter')));
        ...
        $fieldset->addField('from', 'date', array(
            ...
            'label'     => Mage::helper('skureports')->__('From'),
            'title'     => Mage::helper('skureports')->__('From')
        ));
        $fieldset->addField('to', 'date', array(
            'name'      => 'to',
            'format'    => $dateFormatIso,
            'image'     => $this->getSkinUrl('images/grid-cal.gif'),
            'label'     => Mage::helper('skureports')->__('To'),
            'title'     => Mage::helper('skureports')->__('To')
        ));
        $fieldset->addField('period_type', 'select', array(
            'name'      => 'period_type',
            'options'   => $this->_getPeriodTypeOptions(),
            'label'     => Mage::helper('skureports')->__('Period')
        ));
        ...
        $fieldset->addField('shipping_rate', 'select', array(
            ...
            'label'     => Mage::helper('skureports')->__('Show values where shipping rate greater than 0')
        ));
    ...
    {
        $options        = array(
            'day'       => Mage::helper('skureports')->__('Day'),
            'month'     => Mage::helper('skureports')->__('Month'),
            'year'      => Mage::helper('skureports')->__('Year'),
        );
