...
class Vishal_Skureports_Block_Adminhtml_Report extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     * This is your module alias
     */
    protected $_blockGroup      = 'skureports';
    /**
    ...
    /*
        ...
        So the complete block would called skureports/adminhtml_report_grid . As you already guessed it,
        this will resolve to the class skureports_Adminhtml_Report_Grid .
     */
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('skureports')->__('Sales by SKU');
        ...
        $this->addButton('filter_form_submit', array(
            'label'     => Mage::helper('skureports')->__('Show Report'),
